...
export const getFirstAvailableRoute = (permissions: NavigationPermissions | null): string => {
  ...
  const routeChecks = [
    ...
    { path: '/reports/invoice-report', permission: permissions.Reports?.['Invoice Report'] },
    { path: '/reports/production-order-summary', permission: permissions.Reports?.['Production order summary'] },
    { path: '/reports/core-report', permission: permissions.Reports?.['Core Report'] },
    { path: '/reports/backlog-report', permission: permissions.Reports?.['Backlog report'] },
    { path: '/reports/daily-production-summary', permission: permissions.Reports?.['Daily production summary'] },
    { path: '/reports/advanced-planning', permission: permissions.Reports?.['Advanced Planning'] },
    { path: '/reports/needle-wise-planning', permission: permissions.Reports?.['Needle Wise Planning'] },
