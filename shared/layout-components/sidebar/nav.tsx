...
const BaseMenuItems: any = [
  ...
  },
  {
    ...
    children: [
      {
        icon: ReportsIcon,
        path: "/reports/production-order-summary",
        type: "link",
        active: false,
        selected: false,
      ...
      {
        icon: ReportsIcon,
        path: "/reports/daily-production-summary",
        type: "link",
        active: false,
        selected: false,
      ...
      {
        icon: ReportsIcon,
        path: "/reports/advanced-planning",
        type: "link",
        active: false,
        selected: false,
      ...
      {
        icon: ReportsIcon,
        path: "/reports/needle-wise-planning",
        type: "link",
        active: false,
        selected: false,
        title: "Needle Wise Planning",
      },
      {
        icon: ReportsIcon,
        path: "/reports/backlog-report",
        type: "link",
        active: false,
        selected: false,
