...
import { CreateOrderData } from '@/shared/services/orderService';
...
const AddOrderPage = () => {
  ...
  const { createOrder, loading: apiLoading } = useOrders();
    ...
    switch (currentTab) {
      case 0: // Order Info
        if (!formData.externalOrderId.trim()) {
          newErrors.externalOrderId = 'External Order ID is required';
        }
        break;
      ...
      case 0: // Order Info
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* External Order ID */}
            <div>
              <label className="form-label">External Order ID *</label>
              <input
                type="text"
                className={`form-control ${errors.externalOrderId ? 'border-danger' : ''}`}
                value={formData.externalOrderId}
                onChange={(e) => handleInputChange('externalOrderId', e.target.value)}
                placeholder="ORD-12345"
              />
              {errors.externalOrderId && (
                <div className="text-danger text-sm mt-1">{errors.externalOrderId}</div>
              )}
            </div>
          ...
          <div className="box !bg-transparent border-0 shadow-none">
            <div className="box-header flex justify-between items-center">
              <div className="flex items-center gap-3">
                <h1 className="box-title text-2xl font-semibold">Add New Order</h1>
                <HelpIcon
                  title="Add New Order"
                  content={
                    <div>
                      <p className="mb-4">
                        This page allows you to create a new order manually by filling out comprehensive order information across multiple tabs.
                      </p>
                      
                      <h4 className="font-semibold mb-2">What you can do:</h4>
                      <ul className="list-disc list-inside mb-4 space-y-1">
                        <li><strong>Order Info:</strong> Enter order source, external ID, and status</li>
                        <li><strong>Customer Details:</strong> Add customer information and shipping address</li>
                        <li><strong>Items:</strong> Add multiple items with SKU, quantity, and pricing</li>
                        <li><strong>Payment:</strong> Set payment method and status</li>
                        <li><strong>Logistics:</strong> Configure warehouse and shipping details</li>
                      ...
                      <ul className="list-disc list-inside mb-4 space-y-1">
                        <li><strong>External Order ID:</strong> Unique order identifier from source</li>
                        <li><strong>Customer Name:</strong> Full name of the customer</li>
                        <li><strong>Email & Phone:</strong> Valid contact information (Indian format)</li>
                        <li><strong>Address:</strong> Complete shipping address with pincode</li>
                        <li><strong>Items:</strong> At least one item with valid SKU and pricing</li>
                      </ul>

                      <h4 className="font-semibold mb-2">Tips:</h4>
                      <ul className="list-disc list-inside space-y-1">
                        <li>Complete each tab before moving to the next</li>
                        <li>Order total is auto-calculated from items (in ₹)</li>
                        <li>Payment amount updates automatically when items change</li>
                        <li>Pincode must be 6 digits (Indian format)</li>
