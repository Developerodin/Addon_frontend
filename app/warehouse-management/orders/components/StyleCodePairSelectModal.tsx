...
const getPairId = (row: StyleCodePair) => row.id ?? row._id ?? "";
...
type Props = {
  open: boolean;
  onClose: () => void;
  onSelect: (pair: StyleCodePair) => void;
};

/**
 * Browse style-code pairs (multi-pair catalog) — same data source as /catalog/style-code-pairs.
 */
export default function StyleCodePairSelectModal({ open, onClose, onSelect }: Props) {
  ...
  useEffect(() => {
    ...
    const fetchList = async () => {
      ...
      try {
        ...
        console.error("Failed to load style code pairs", e);
        setRows([]);
        setTotalPages(1);
        setTotalResults(0);
      } finally {
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
          <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
            <h3 className="text-base font-semibold text-gray-900">Browse style code pairs</h3>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="p-4 border-b border-gray-100">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search pair style code, EAN..."
          ...
          <div className="flex-1 overflow-auto p-4">
            {loading ? (
              ...
              <div className="py-12 text-center text-gray-500 text-sm">No pairs found.</div>
            ) : (
                ...
                <table className="w-full border-collapse border border-gray-200 text-left">
                  ...
                  <tbody>
                    {rows.map((row) => {
                      ...
                      return (
                        <tr key={id || row.pairStyleCode} className="hover:bg-gray-50/50 border-b border-gray-100">
