...
import yarnBlendService from '@/shared/services/yarnBlendService';
...
const AddBlendPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await yarnBlendService.createBlend({
      ...
      toast.error(error instanceof Error ? error.message : 'Failed to create blend');
    } finally {
    ...
    return (
      <div className="main-content">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">You don't have permission to add blends.</p>
        ...
        <div className="col-span-12">
          <div className="box !bg-transparent border-0 shadow-none">
            <div className="box-header flex justify-between items-center">
              <h1 className="box-title text-2xl font-semibold">Add Blend</h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-3">
                  ...
                  <button type="submit" className="ti-btn ti-btn-primary" disabled={isSubmitting}>
                    {isSubmitting ? <>Creating...</> : <><i className="ri-save-line me-2"></i> Create Blend</>}
                  </button>
                </div>
              </form>
            </div>
