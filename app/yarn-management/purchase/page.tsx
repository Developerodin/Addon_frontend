    ...
    return (
      <div className="main-content">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 mb-4">You don't have permission to access Yarn Purchase.</p>
        ...
        <div className="col-span-12">
          ...
          <div className="box !bg-transparent border-0 shadow-none">
            <div className="box-header flex justify-between items-center">
              <div>
                <h1 className="box-title text-2xl font-semibold">Yarn Purchase</h1>
                <p className="text-gray-600 mt-1">Manage yarn procurement and purchase orders</p>
              </div>
              <div className="box-tools">
               
                <Link 
                  href="/yarn-management/purchase/add"
