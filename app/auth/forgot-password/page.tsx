                    ...
                    <div className="box-body !p-[3rem]">
                        ...
                        <div className="grid grid-cols-12 gap-y-4">
                            ...
                            <div className="xl:col-span-12 col-span-12 grid mt-2">
                                <Link href="/authentication/sign-in/signin-basic/" className="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">Create</Link>
                            </div>
                        </div>
                        <div className="text-center">
                            <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Already have an account? <Link href="/authentication/sign-in/signin-basic/" className="text-primary">Sign In</Link></p>
                        </div>
