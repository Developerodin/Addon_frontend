...
/**
 * Drawer to mark M3 quantity as outward with required remarks.
 */
  ...
  return (
    <>
      ...
      <aside
        ...
        role="dialog"
        aria-labelledby="m3-outward-title"
        aria-modal="true"
      >
        <header className="px-4 py-3 border-b border-gray-200 flex items-center justify-between bg-orange-50">
          <h2 id="m3-outward-title" className="text-sm font-bold text-orange-900">
            Mark M3 Outward
          </h2>
          <button
            type="button"
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div>
            <label htmlFor="m3-outward-qty" className="block text-[11px] font-bold text-gray-800 mb-1">
              Outward quantity
            </label>
            <NumericInput
              id="m3-outward-qty"
          ...
          <div>
            <label htmlFor="m3-outward-remarks" className="block text-[11px] font-bold text-gray-800 mb-1">
              Remarks <span className="text-orange-600">*</span>
            </label>
            <textarea
              id="m3-outward-remarks"
              rows={4}
              value={remarks}
