...
/**
 * Article-wise M4 table with combined totals (all floors summed).
 */
              ...
              paged.map((row) => {
                ...
                return (
                  <tr key={row._id ?? row.id} className="hover:bg-gray-50/50">
                    ...
                    <td className="border border-gray-300 px-1 py-1 text-right bg-red-50/50 font-bold text-red-900">
                      {s.onHand}
                    </td>
                    ...
                    <td className="border border-gray-300 px-1 py-1 text-center">
                      <div className="flex justify-center gap-1">
                        ...
                        <button
                          ...
                          aria-label={`View M4 detail for ${row.articleNumber}`}
                        >
                          View
                        </button>
                        <button
