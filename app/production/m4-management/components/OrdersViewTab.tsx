...
export default function OrdersViewTab({
  ...
  /** Export filtered M4 order/article rows (flat per-article) as CSV. */
  const handleExportExcel = () => {
    ...
    if (exportRows.length === 0) {
      toast.error("No M4 orders to export");
      return;
    }
    ...
    downloadCsv(datedExportFilename("m4-orders"), [header, ...lines]);
    ...
    <div>
      <div className="flex flex-wrap items-center gap-2 mb-3">
        ...
        <DownloadExcelButton
          ...
          ariaLabel="Export filtered M4 orders to Excel"
        />
      </div>
