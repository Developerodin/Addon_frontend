...
/**
 * Single article block for "View active article" drawer on Checking floor – Excel-like small font.
 * Shows checking floor quantities; Article complete button calls DELETE active-article.
 */
export default function ArticleDetailBlock({
  ...
  const machine =
    typeof art.machineId === "object" && art.machineId && "machineCode" in art.machineId
      ...
      : null;
  const check = art.floorQuantities?.checking;
      ...
      <table className="w-full border-collapse text-[10px]">
        <tbody>
          ...
          {check != null && (
            <>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Checking Rcv</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{check.received}</td>
              </tr>
              <tr>
              ...
              {check.m1Quantity != null && (
                <tr>
                  ...
                  <td className="border border-gray-200 px-1.5 py-0.5">{check.m1Quantity}</td>
                </tr>
              )}
            </>
          )}
