...
/**
 * Single article block for "View active article" drawer on Final Checking floor.
 * Shows finalChecking floor quantities; Article complete button calls DELETE active-article.
 */
export default function ArticleDetailBlock({
  ...
  const machine =
    typeof art.machineId === "object" && art.machineId && "machineCode" in art.machineId
      ...
      : null;
  const fc = (art as any).floorQuantities?.finalChecking;
      ...
      <table className="w-full border-collapse text-[10px]">
        <tbody>
          ...
          {fc != null && (
            <>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Final Check Rcv</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{fc.received}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Final Check Rem</td>
