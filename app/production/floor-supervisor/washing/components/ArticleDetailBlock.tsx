...
/**
 * Single article block for "View active article" drawer on Washing floor.
 * Shows washing floor quantities; Article complete button calls DELETE active-article.
 */
export default function ArticleDetailBlock({
  ...
  const machine =
    typeof art.machineId === "object" && art.machineId && "machineCode" in art.machineId
      ...
      : null;
  const wash = art.floorQuantities?.washing;
      ...
      <table className="w-full border-collapse text-[10px]">
        <tbody>
          ...
          {wash != null && (
            <>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Washing Rcv</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{wash.received}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Washing Done</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{wash.completed ?? 0}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Washing Rem</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{wash.remaining ?? wash.received - (wash.transferred ?? 0)}</td>
              </tr>
            </>
          )}
          {order && (
