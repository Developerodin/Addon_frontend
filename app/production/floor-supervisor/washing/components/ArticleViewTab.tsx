        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          {onScanContainerClick && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold rounded bg-cyan-600 text-white hover:bg-cyan-700 shadow-sm"
            >
          ...
          <tbody>
            {filteredRows.map(({ article, order }) => {
              ...
              return (
                <tr
                  key={key}
                  className={`hover:bg-gray-50/50 transition-colors group ${isActiveRow ? "ring-2 ring-cyan-500 ring-inset bg-cyan-50/50" : ""}`}
                >
                  ...
                  <td className="px-1.5 py-2.5 text-center text-[12px] text-cyan-600 font-medium border border-gray-200">
