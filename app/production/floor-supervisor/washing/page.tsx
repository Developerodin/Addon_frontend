                ...
                <table className="min-w-full text-xs border-collapse">
                  <thead className="bg-gray-100 border-b border-gray-300">
                    <tr>
                      ...
                      <th className="px-2 py-1.5 text-center font-semibold text-gray-700 border-r border-gray-300 whitespace-nowrap bg-yellow-50">Washing Completed *</th>
                              ...
                              <NumericInput
                                className={`py-1 text-xs h-7 ${
                                  isFullyTransferred 
                                    ...
                                    : currentUpdateData.completedQuantity > remainingQty 
