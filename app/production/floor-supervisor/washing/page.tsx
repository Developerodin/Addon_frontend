          ...
          <div className="box !bg-transparent border-0 shadow-none">
            <div className="box-header flex justify-between items-center">
              <div className="flex items-center space-x-3">
                <h1 className="box-title text-2xl font-semibold">Washing Floor Supervisor Dashboard</h1>
                <HelpIcon
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                          ...
                          <li><strong>Track Quantities:</strong> Monitor planned, received from checking, and completed quantities</li>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-4">
                    {hasActiveFilters 
                      ...
                      : 'No orders currently on Washing floor'
                    }
                  </p>
                </div>
              ) : (
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            <div className="space-y-1">
                              ...
                              {order.articles.some(article => article.floorQuantities?.washing) && (
                                <div className="text-xs text-blue-600">
                                  Washing: R:{order.articles.reduce((sum, article) => sum + (article.floorQuantities?.washing?.received || 0), 0)} | 
                ...
                return (
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        <label className="form-label">Washing Completed Quantity *</label>
                        <input
                          type="number"
                          className="form-control"
                          ...
                          min="0"
                          max={article.floorQuantities?.washing?.received || 0}
                        />
                        <div className="text-xs text-gray-500 mt-1">
                          Transferred to next floor: {article.floorQuantities?.washing?.transferred || 0}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-sm text-gray-600">
                      <div>
                        Remaining: {(article.floorQuantities?.washing?.remaining || 0).toLocaleString()}
                      </div>
                      <div>
                        Progress: {Math.round((currentUpdateData.completedQuantity / (article.floorQuantities?.washing?.received || 1)) * 100)}%
                      </div>
                    </div>
                ...
                return (
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-semibold text-green-600">
                          {article.floorQuantities?.washing?.transferred || 0}
                        </div>
                        <div className="text-xs text-gray-500 mt-1">
                          Transferred to next floor: {article.floorQuantities?.washing?.transferred || 0}
                        </div>
                    ...
                    <div className="flex justify-between items-center text-sm text-gray-600">
                      ...
                      <div>
                        Progress: {Math.round(((article.floorQuantities?.washing?.transferred || 0) / (article.floorQuantities?.washing?.received || 1)) * 100)}%
                      </div>
                    </div>
                  </div>
                );
