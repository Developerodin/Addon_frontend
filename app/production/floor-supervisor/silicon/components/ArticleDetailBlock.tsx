...
/**
 * Single article block for "View active article" drawer on Silicon floor.
 * Shows silicon floor quantities; Article complete button calls DELETE active-article.
 */
export default function ArticleDetailBlock({
  ...
  const machine =
    typeof art.machineId === "object" && art.machineId && "machineCode" in art.machineId
      ...
      : null;
  const silicon = art.floorQuantities?.silicon;
      ...
      <table className="w-full border-collapse text-[10px]">
        <tbody>
          ...
          {silicon != null && (
            <>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Silicon Rcv</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{silicon.received}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Silicon Done</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{silicon.completed ?? 0}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Silicon Rem</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{silicon.remaining ?? silicon.received - (silicon.transferred ?? 0)}</td>
              </tr>
            </>
          )}
          {order && (
          ...
          {machine && (
            <>
              ...
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Number</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{machine.machineNumber ?? "—"}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Model</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{machine.model ?? "—"}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Floor</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{machine.floor ?? "—"}</td>
              </tr>
              <tr>
                <td className="border border-gray-200 px-1.5 py-0.5 font-medium text-gray-600 bg-gray-100">Status</td>
                <td className="border border-gray-200 px-1.5 py-0.5">{machine.status ?? "—"}</td>
              </tr>
            </>
          )}
        </tbody>
