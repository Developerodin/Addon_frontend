          ...
          <div className="box !bg-transparent border-0 shadow-none">
            <div className="box-header flex justify-between items-center">
              <div className="flex items-center space-x-3">
                <h1 className="box-title text-2xl font-semibold">Silicon Floor Supervisor Dashboard</h1>
                <HelpIcon
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-gray-700">
                          This is the Silicon Floor Supervisor Dashboard where you can view and update production orders that are currently on the Silicon floor.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                          ...
                          <li><strong>Track Quantities:</strong> Monitor planned, received from washing, and completed quantities</li>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-4">
                    {hasActiveFilters 
                      ...
                      : 'No orders currently on Silicon floor'
                    }
                  </p>
                </div>
              ) : (
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            <div className="space-y-1">
                              ...
                              {order.articles.some(article => article.floorQuantities?.silicon) && (
                                <div className="text-xs text-blue-600">
                                  Silicon: R:{order.articles.reduce((sum, article) => sum + (article.floorQuantities?.silicon?.received || 0), 0)} | 
                                  Rem:{order.articles.reduce((sum, article) => sum + (article.floorQuantities?.silicon?.remaining || 0), 0)}
                                </div>
                              )}
                ...
                <table className="min-w-full text-xs border-collapse">
                  <thead className="bg-gray-100 border-b border-gray-300">
                    <tr>
                      ...
                      <th className="px-2 py-1.5 text-center font-semibold text-gray-700 border-r border-gray-300 whitespace-nowrap bg-yellow-50">Silicon Completed *</th>
