...
const FLOOR_BOARDING = "Boarding" as const;

/** Shows team members whose workingFloor is Boarding. */
  ...
  return (
    <div className="p-[10px]">
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        <span className="text-[11px] font-medium text-[#495057]">{totalResults} member{totalResults !== 1 ? "s" : ""} on Boarding floor</span>
      </div>
      <div className="border border-gray-200 rounded overflow-hidden">
        <table className="w-full border-collapse border border-gray-200">
          ...
          <tbody className="bg-white">
            {members.length === 0 ? (
              <tr><td colSpan={5} className="px-4 py-12 text-center text-[11px] text-gray-500">No team members found for Boarding floor.</td></tr>
            ) : (
              members.map((row) => {
