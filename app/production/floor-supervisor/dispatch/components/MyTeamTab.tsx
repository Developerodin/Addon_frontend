...
const FLOOR_DISPATCH = "Dispatch" as const;

/** Team members whose workingFloor is Dispatch. */
    ...
    <div className="p-[10px]">
      <div className="flex flex-wrap items-center gap-2 mb-4">
        ...
        <span className="text-[11px] font-medium text-[#495057]">
          {totalResults} member{totalResults !== 1 ? "s" : ""} on Dispatch floor
        </span>
      </div>
            ...
            {members.length === 0 ? (
              <tr>
                <td colSpan={5} className="px-4 py-12 text-center text-[11px] text-gray-500">
                  No team members found for Dispatch floor.
                </td>
              </tr>
            ) : (
              members.map((row) => {
