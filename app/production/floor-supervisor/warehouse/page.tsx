                ...
                return (
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div>
                        <label className="form-label">Warehouse Received Quantity</label>
                        <div className="text-lg font-semibold text-green-600">
                          {article.floorQuantities?.warehouse?.transferred || 0}
                        </div>
                        <div className="text-xs text-gray-500 mt-1">
                          Ready for dispatch: {article.floorQuantities?.warehouse?.transferred || 0}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-sm text-gray-600">
                      ...
                      <div>
                        Progress: {Math.round(((article.floorQuantities?.warehouse?.transferred || 0) / (article.floorQuantities?.warehouse?.received || 1)) * 100)}%
                      </div>
                    </div>
                  </div>
                );
