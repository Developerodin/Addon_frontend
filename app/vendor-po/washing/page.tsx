    ...
    <div className={CRM.mainContent}>
      ...
      <div className={CRM.titleRow}>
        <div className={CRM.titleWithAccent}>
          ...
          <h1 className={CRM.pageTitle}>Washing Stage</h1>
          <HelpIcon
            ...
            <table className={CRM.table}>
              ...
              <tbody>
                {paginatedFlows.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="py-10 text-center text-gray-400 text-xs font-bold uppercase tracking-widest">
                  ...
                  paginatedFlows.map((flow) => {
                    ...
                    return (
                      <tr key={flow.id} className={CRM.tbodyTr}>
                        ...
                        <td className={`${CRM.td} text-right font-medium`}>{ws.received.toLocaleString()}</td>
                        <td className={`${CRM.td} text-right font-bold text-emerald-600`}>{ws.completed.toLocaleString()}</td>
                        <td className={`${CRM.td} text-right text-sky-600`}>{ws.transferred.toLocaleString()}</td>
                        <td className={CRM.td}>
