  ...
  const handleExportExcel = () => {
    ...
    const lines = articleRows.map((row) => {
      ...
      const styleBreakdown = br.transferredData?.length
        ? enrichBrandingTransferredDataForDisplay(br.transferredData, row.flow)
            .map((t) => formatTransferredRowLabel(t))
            .join("; ")
        : "";
      return [
    ...
    downloadCsv("vendor_branding_articles.csv", [header, ...lines]);
  };
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3 px-[10px] pt-[10px]">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Export branding articles to Excel"
          >
