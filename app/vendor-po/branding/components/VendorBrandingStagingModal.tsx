...
export function VendorBrandingStagingModal({
  ...
  const persistAndTransfer = async () => {
    ...
    try {
      ...
      setStep("success");
      toast.success(
        "Staged on container — Final Checking receives after accept scan",
      );
      ...
      >
        <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200">
          <h3 className="text-sm font-bold text-gray-800">
            {step === "success"
              ? "Staged for Final Checking"
              : "Scan container — save & stage to Final FC"}
          </h3>
          <button
            type="button"
            onClick={close}
          ...
          {step === "success" ? (
            <div className="space-y-3">
              <p className="text-gray-700">
                Scan this barcode on <strong>Final Checking</strong> (accept) to
                increase received.
              </p>
                ...
                <div className="rounded border border-emerald-200 bg-emerald-50/60 p-3 space-y-2">
                  ...
                  {articles.length > 0 ? (
                    ...
                    <p className="text-emerald-800 font-semibold">
                      ...
                      and autoTransferToNextFloor to stage Final Checking.
                    </p>
                  )}
                  <button
                    type="button"
