...
export default function OrdersViewTab({
  ...
  /** Export filtered vendor M3 VPO/flow rows (flat per-flow) as CSV. */
  const handleExportExcel = () => {
    ...
    if (exportRows.length === 0) {
      toast.error("No M3 VPO data to export");
      return;
    }
    ...
    downloadCsv(datedExportFilename("vendor-m3-vpo"), [header, ...lines]);
    ...
    <div>
      <div className="flex flex-wrap items-center gap-2 mb-3">
        ...
        <DownloadExcelButton
          ...
          ariaLabel="Export filtered vendor M3 VPO data to Excel"
        />
      </div>
